(function (context) {
  ...
  /**
   * Launch the sign in flow and return a promise.
   * If resolved (i.e. on a successful sign in) the callback will be passed an
   * object containing details about the access token;
   * ```javascript
   * {
   *   access_token: "string",
   *   token_type: "bearer",
