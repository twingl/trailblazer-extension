...
module.exports = React.createClass({
  ...
  render: function () {
    console.log('rendeing mapview')
    var feedbackText = "Feedback |";
    var shareText = this.props.visable ? "Shared" : "Share";

    return  <div onClick={this.handleClick}>
              <MapTitle title={this.props.title} />
              <div id="map-container" >
                <Map id="map" width={960} height={500} selector="#map" data={this.props.data} />
              </div>
              <span className="help" >
                <a
                  className="feedback"
