...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var assignmentState   = state.get('assignmentState').toJS()
    var id = assignmentState.currentAssignment;
    var assignment = assignmentState.assignmentsIndex[id];
    var nodeState = state.get('nodeState').toJS();

    var nodeObj = Object.keys(nodeState.nodeIndex)
      .filter(function (key) { 
        return nodeState.nodeIndex[key].assignmentId === id
      })
      .reduce(function (acc, key) {
        acc[key] = nodeState.nodeIndex[key]
      }, {})
    ...
    if (assignment) {
      ...
      shareText     = (visible) ? "Shared" : "Share";
